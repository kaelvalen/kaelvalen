      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12 text-left">
          <div className="bg-bg-card border border-border rounded-xl p-6">
            <h3 className="text-sm font-mono text-accent-green uppercase tracking-wider mb-4">
          ...
          <div className="bg-bg-card border border-border rounded-xl p-6">
            <h3 className="text-sm font-mono text-red-400 uppercase tracking-wider mb-4">
              Not interested in
            </h3>
            <ul className="space-y-3">
              {[
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <a
            ...
            className="flex items-center gap-2 px-5 py-3 bg-accent hover:bg-accent-hover text-white rounded-lg font-medium transition-colors"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          <a
            ...
            className="flex items-center gap-2 px-5 py-3 border border-border hover:border-accent text-text-secondary hover:text-accent rounded-lg font-medium transition-colors"
          >
